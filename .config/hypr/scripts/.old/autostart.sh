...
exec-once = $HOME/.config/hypr/scripts/rdunst.sh # notification app
exec-once = $HOME/.config/hypr/scripts/toggle-waybar.sh # toggle waybar
exec-once = $HOME/.config/hypr/scripts/autostart_app/idle_handler.sh # swayidle lockscreen with swaylock
...
exec-once = swww init # wallpaper demon
